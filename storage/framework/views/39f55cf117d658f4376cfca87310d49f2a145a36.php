                                            ...
                                            <div class="col-md-4">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html" class="banner banner-menu">
                                                        <img src="<?php echo e(asset('public')); ?>/assets/images/menu/banner-1.jpg" alt="Banner">
                                            ...
                                            <div class="col-md-6">
                                                <div class="banner banner-overlay">
                                                    <a href="category.html">
                                                        <img src="<?php echo e(asset('public')); ?>/assets/images/menu/banner-2.jpg" alt="Banner">
	            	...
	            	<div class="row">
	            		<div class="col-sm-6 col-lg-3">
	            			<div class="widget widget-about">
	            				<img src="<?php echo e(asset('public')); ?>/assets/images/logo-footer.png" class="footer-logo" alt="Footer Logo" width="105" height="25">
	        ...
	        <div class="footer-bottom">
	        	<div class="container">
	        		...
	        		<figure class="footer-payments">
	        			<img src="<?php echo e(asset('public')); ?>/assets/images/payments.png" alt="Payment methods" width="272" height="20">
                ...
                <div class="row no-gutters bg-white newsletter-popup-content">
                    <div class="col-xl-3-5col col-lg-7 banner-content-wrap">
                        <div class="banner-content text-center">
                            <img src="<?php echo e(asset('public')); ?>/assets/images/popup/newsletter/logo.png" class="logo" alt="logo" width="60" height="15">
                    ...
                    <div class="col-xl-2-5col col-lg-5 ">
                        <img src="<?php echo e(asset('public')); ?>/assets/images/popup/newsletter/img-1.jpg" class="newsletter-img" alt="newsletter">
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\xampp\htdocs\project_nafis\resources\views/layouts/app3.blade.php ENDPATH**/ ?>